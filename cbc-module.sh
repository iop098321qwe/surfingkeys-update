...
sktu() {
  gum confirm "Do you want to update the SurfingKeys configuration with Catppuccin Mocha theme?" &&
    command cp -f -- "$HOME/Documents/github_repositories/surfingkeys_theme/catppuccin-mocha-surfingkeys.js" "$HOME/.config/surfingkeys/catppuccin-mocha-surfingkeys.js" &&
